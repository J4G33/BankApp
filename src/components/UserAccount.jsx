...
import UpdateProfilePopUp from "./popups/ServicesPopUp";
    ...
    datasets: [
      {
        ...
        backgroundColor: ["rgba(60, 179, 113, 2.5)", "rgba(255, 0, 0, 0.5)"],
        borderColor: ["rgb(60, 60, 60)", "rgb(60, 60, 60)"],
        borderWidth: 2,
      },
    ],
  });
      ...
      <div className="userInfo-container" style={{ boxShadow: "none", textAlign: "center", paddingTop: "15px" }}>
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
          ...
          <div style={{ marginLeft: "3px" }}>
            <h5>Current Balance: ${loggedInUser.balance}</h5>
          </div>
        </div>
      </div>

      <div className="report-container" style={{ boxShadow: "none", marginBottom: "50px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        <div style={{ boxShadow: "none", marginBottom: "3px", textAlign: "center", maxHeight: "400px", overflow: "auto" }}>
          <h4>Trasaction List</h4>
          <Transactions />
        </div>
        <div className="chart-container" style={{ boxShadow: "none", outline: "2px solid #292b27", display: "flex", justifyContent: "center", alignItems: "center" }}>
